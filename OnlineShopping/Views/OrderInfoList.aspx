        ...
        <div>
            <asp:GridView ID="gvOrderInfo" runat="server" AutoGenerateColumns="false" AlternatingRowStyle-BackColor="Silver" Font-Size="12px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="OrderDate" HeaderText="Order Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="EstDeliveryDate" HeaderText="Est. Delivery Date" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Center" />                    
                    ...
                    <asp:BoundField DataField="OrderStatus" HeaderText="Order Status" ItemStyle-Width="90" ItemStyle-HorizontalAlign="Center"/>
                    ...
                    <asp:BoundField DataField="OrderID" HeaderText="Link" HtmlEncode="False" DataFormatString="<a href='OrderDetailInfo.aspx?OrderID={0}'>Go to Detail</a>" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </asp:GridView>
        </div>
    </div>
